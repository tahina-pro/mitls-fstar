...
type st_inv (#i:gid) (d:reader i) (e:writer i) (h:TLSMem.t) =
    matching d e
...
type st_enc_inv (#i:gid) (e:writer i) (h:TLSMem.t) =
...
type st_dec_inv (#i:gid) (d:reader i) (h:TLSMem.t) =
...
val decrypt: #i:gid -> #ad:adata i -> rd:reader i
  ...
  (ensures (fun h0 (res:option (dplain i ad c)) h1 ->
             ...
             /\ TLSMem.contains (Map.sel h0 (StReader.region rd)) (as_ref (StReader.log rd))
